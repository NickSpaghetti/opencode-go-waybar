...
namespace OpencodeGoWaybar.UnitTests.Brokers.Apis.Usage;

public sealed class UsageBrokerTests
{
    [Fact]
    public async Task SendsBearerKeyAndParsesUsageResponse()
    {
        ...
        var broker = new UsageBroker(client, new Uri("https://mock.test/v1/usage"));
    ...
    [Fact]
    public async Task ReturnsUnauthorizedStatusToFoundation()
    {
